...
// Temporal Dead Zone => TDZ => when we try to access the variable before initialization then it will throw reference error.

// console.log(myName); // ReferenceError: Cannot access 'myName' before initialization
// let myName = "Shivohaam";

// console.log(myName); // Shivohaam

// console.log(myName); // ReferenceError: Cannot access 'myName' before initialization
// const myName = "Shivohaam";
// console.log(myName);

console.log(myName); // undefined
var myName = "Shivohaam";
console.log(myName); // Shivohaam
